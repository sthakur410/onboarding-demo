...
It is generated from these files:
	onboarding-demo/pkg/pb/service.proto
...
type OnboardingDemoDefaultServer struct {
	DB *gorm1.DB
}

// GetVersion ...
func (m *OnboardingDemoDefaultServer) GetVersion(ctx context.Context, in *google_protobuf.Empty) (*VersionResponse, error) {
	out := &VersionResponse{}
	return out, nil
}

// ReadUser ...
func (m *OnboardingDemoDefaultServer) ReadUser(ctx context.Context, in *ReadUserReq) (*ReadUserRes, error) {
	user := &User{Id: in.GetId()}
	u, err := DefaultReadUser(ctx, user, m.DB)
	if err != nil {
		return nil, err
	}
	out := &ReadUserRes{User: u}
	return out, nil
}

// CreateUser ...
func (m *OnboardingDemoDefaultServer) CreateUser(ctx context.Context, in *CreateUserReq) (*CreateUserRes, error) {
	res, err := DefaultCreateUser(ctx, in.GetUser(), m.DB)
	if err != nil {
		return nil, err
	}
	out := &CreateUserRes{User: res}
	// out := &CreateUserRes{User: &User{Id: "10"}}
	return out, nil
}
